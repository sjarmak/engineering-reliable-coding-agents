...
\textbf{Chapter claim.} Coordination must earn its cost against a live single-agent baseline.
\end{quote}
...
\textbf{Portable claim.} Coordination must earn its cost against a live single-agent baseline.
