...
The catalog makes that mismatch concrete. \emph{Contain agent blast radius} ranked first by consequence, yet its incident support consists of two corroborating Reddit accounts: a \href{https://www.reddit.com/r/LLMDevs/comments/1q7avil/}{production-workflow report} and a \href{https://www.reddit.com/r/devops/comments/1tbbls4/}{database-deletion report}. Both have archived snapshots in the companion. They show that the failure can occur, not how often it occurs. I still recommend the control because the current authority boundary can be inspected directly, a prohibited write can be exercised safely against a test resource, and separating ordinary from recovery authority is reversible. The recommendation is mechanism-justified rather than prevalence-justified.
...
\item
  Strong evidence: Zhang, S., et al.~(2025). Which Agent Causes Task Failures and When? On Automated Failure Attribution of LLM Multi-Agent Systems. ICML 2025. arXiv:2505.00212. Chapter 11, \texttt{keep-humans-in-failure-attribution}.
\item
...
\item
  Strong evidence: Chen, J., et al.~(2016). Sampling as a Baseline Optimizer for Search-Based Software Engineering. arXiv:1608.07617. Chapter 19, \texttt{replay-traces-before-policy-changes}.
\end{itemize}
