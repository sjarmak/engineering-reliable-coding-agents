...
\begin{quote}
\textbf{Evidence profile.} 7 strong \(\cdot\) 7 directional \(\cdot\) 1 corroborating evidence items across 4 developed practices (ERCA-001, ERCA-003, ERCA-004, ERCA-066).
...
\textbf{Portable claim.} A passing score is only as valid as its workload, exposure boundary, and oracle.
