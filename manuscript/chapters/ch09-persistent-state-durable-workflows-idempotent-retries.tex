...
Attempt & One execution of that work; a retry is a new attempt at the same logical work (contract I4, retries preserve logical identity). \\
...
Idempotency & The contract under which a repeated external commit is indistinguishable from a single one (contract I5, effects are safe under redelivery or explicitly uncertain). \\
