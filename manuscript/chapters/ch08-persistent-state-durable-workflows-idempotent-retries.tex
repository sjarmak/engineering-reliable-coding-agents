...
\begin{quote}
\textbf{Evidence profile.} 0 strong \(\cdot\) 8 directional \(\cdot\) 3 corroborating \(\cdot\) 1 null or conflicting evidence items across 3 developed practices (ERCA-124, ERCA-128, ERCA-130).
