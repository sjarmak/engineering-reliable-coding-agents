...
\begin{quote}
\textbf{Evidence profile.} 3 strong \(\cdot\) 3 directional \(\cdot\) 0 corroborating evidence items across 3 developed practices (\erca{038}, \erca{039}, \erca{042}). One directional item is carried by a companion record cited inline (\erca{199}).

\textbf{Chapter claim.} Any optimized proxy needs an independent signal.
\end{quote}
...
\hypertarget{did-the-verifier-run-and-did-it-run-on-this-artifact}{%
\section{Did the verifier run, and did it run on this artifact?}\label{did-the-verifier-run-and-did-it-run-on-this-artifact}}
