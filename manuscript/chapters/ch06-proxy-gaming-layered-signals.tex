...
\begin{quote}
\textbf{Evidence profile.} 3 strong \(\cdot\) 3 directional \(\cdot\) 0 corroborating evidence items across 3 developed practices (ERCA-038, ERCA-039, ERCA-042).
...
\textbf{Portable claim.} Any optimized proxy needs an independent signal.
