...
\begin{quote}
\textbf{Evidence profile.} 2 strong \(\cdot\) 4 directional \(\cdot\) 0 corroborating evidence items across 3 developed practices (ERCA-081, ERCA-116, ERCA-118).
...
\textbf{Portable claim.} Preserve raw events; rebuild derived memory.
