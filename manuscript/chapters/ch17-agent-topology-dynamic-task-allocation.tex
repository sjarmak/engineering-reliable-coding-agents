...
\begin{quote}
\textbf{Evidence profile.} 6 strong \(\cdot\) 12 directional \(\cdot\) 1 corroborating evidence items across 4 developed practices (ERCA-044, ERCA-093, ERCA-101, ERCA-107).
