...
\begin{quote}
\textbf{Evidence profile.} 1 strong \(\cdot\) 9 directional \(\cdot\) 0 corroborating \(\cdot\) 0 null or conflicting evidence items across 2 developed practices (ERCA-097, ERCA-127). One directional item is a preprint.
