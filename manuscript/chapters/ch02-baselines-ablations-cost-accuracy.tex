...
\begin{quote}
\textbf{Evidence profile.} 1 strong \(\cdot\) 5 directional \(\cdot\) 0 corroborating evidence items across 2 developed practices (ERCA-012, ERCA-114).

\textbf{Chapter claim.} A component that never executes cannot explain the result.
\end{quote}
...
\textbf{Portable claim.} A component that never executes cannot explain the result.
