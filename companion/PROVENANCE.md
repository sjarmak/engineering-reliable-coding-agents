...
- Public manuscript chapter snapshot: packaged with companion version `1.0.0` in the canonical repository.
...
The external-grading packet is retained as the calibration protocol. No readers have been commissioned and no calibration report exists for this edition. The absence of responses is a disclosed limitation, and this edition makes no independent-calibration claim.
