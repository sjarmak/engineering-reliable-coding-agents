...
const SECTION_SPECS = Object.freeze([
  ...
  {
    path: "manuscript/chapters/ch07-software-factory-distributed-system.tex",
    kind: "body",
    prefix: "# Part III: Containment, durable execution, and recovery engineering",
  },
  {
    path: "manuscript/chapters/ch08-isolation-injection-independent-verification.tex",
    kind: "body",
  },
  {
    path: "manuscript/chapters/ch09-persistent-state-durable-workflows-idempotent-retries.tex",
    kind: "body",
  },
  { path: "manuscript/chapters/ch10-replayable-traces-fault-injection-recovery.tex", kind: "body" },
  {
    path: "manuscript/chapters/ch11-human-auditable-failure-analysis-taxonomy.tex",
    kind: "body",
  },
  {
    path: "manuscript/chapters/ch12-measuring-designing-repository-retrieval.tex",
    kind: "body",
    prefix: "# Part IV: Context engineering: retrieval, budgets, and memory",
  },
  {
    path: "manuscript/chapters/ch13-localization-funnels-repository-indexes-freshness-checks.tex",
    kind: "body",
  },
  {
    path: "manuscript/chapters/ch14-usable-context-budgets-spec-restarts-file-output.tex",
    kind: "body",
  },
  {
    path: "manuscript/chapters/ch15-cross-session-memory-raw-traces-compaction.tex",
    kind: "body",
  },
  {
    path: "manuscript/chapters/ch16-verification-interfaces-risk-based-escalation.tex",
    kind: "body",
    prefix: "# Part V: Human review and accountability engineering",
  },
  {
    path: "manuscript/chapters/ch17-autonomy-provenance-gates-accountability.tex",
    kind: "body",
  },
  {
    path: "manuscript/chapters/ch18-agent-topology-dynamic-task-allocation.tex",
    kind: "body",
    prefix: "# Part VI: Research agenda: work allocation and cost engineering",
  },
  {
    path: "manuscript/chapters/ch19-cost-aware-fleet-scheduling-model-routing.tex",
    kind: "body",
  },
